...
require $template_directory . '/includes/components/class-wpmdc-checkbox.php';
require $template_directory . '/includes/components/class-wpmdc-switch.php';
require $template_directory . '/includes/components/class-wpmdc-button.php';
